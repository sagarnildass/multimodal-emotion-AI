...
class VideoUtteranceProcessor:
    ...
    def extract_segment(self, video_path, start_time, end_time, temp_dir="/tmp"):
        ...
        try:
            ...
            # Using copy codec instead of re-encoding
            result = subprocess.run([
                "ffmpeg", "-i", video_path,
                "-ss", str(start_time),
                "-to", str(end_time),
            ...
            print(f"Output segment path: {segment_path}")
            print(f"Output segment exists: {os.path.exists(segment_path)}")
            if os.path.exists(segment_path):
                print(f"Output segment size: {os.path.getsize(segment_path)} bytes")
